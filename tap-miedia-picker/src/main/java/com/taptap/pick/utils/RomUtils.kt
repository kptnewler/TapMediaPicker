...
object RomUtils {
    ...
    private val isMIUIV6OrAbove: Boolean
        get() {
            ...
            if (!TextUtils.isEmpty(miuiVersionCodeStr)) {
                try {
                    val miuiVersionCode: Int = miuiVersionCodeStr?.toIntOrNull() ?: 0
    ...
    val mIUIVersionCode: Int
        get() {
            ...
            if (!TextUtils.isEmpty(miuiVersionCodeStr)) {
                try {
                    miuiVersionCode = miuiVersionCodeStr?.toIntOrNull()?:0
    ...
    private fun stringToInt(str: String?): Int {
        ...
        return if (pattern.matcher(str).matches()) str?.toIntOrNull()?:0 else 0
    }
