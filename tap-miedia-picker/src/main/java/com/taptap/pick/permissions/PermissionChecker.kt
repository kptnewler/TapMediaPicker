...
import com.taptap.pick.ui.fragment.BaseSelectorFragment
import com.taptap.pick.utils.SdkVersionUtils
import com.taptap.pick.utils.SdkVersionUtils.isTIRAMISU
...
object PermissionChecker {
    ...
    fun onRequestPermissionsResult(grantResults: IntArray?, action: OnPermissionResultListener?) {
        if (com.taptap.pick.permissions.PermissionUtil.isAllGranted(grantResults)) {
            action?.onGranted()
        } else {
            action?.onDenied()
        }
