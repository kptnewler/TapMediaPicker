...
public class PreviewGalleryAdapter extends RecyclerView.Adapter<PreviewGalleryAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.ivDelete.setOnClickListener(v -> {
            if (mItemOnDeleteListener != null) {
                mItemOnDeleteListener.onItemDelete(item, position, v);
            }
        });
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            if (StyleUtils.checkStyleValidity(selectMainStyle.getAdapterImageEditorResources())) {
                ivDelete.setImageResource(selectMainStyle.getAdapterImageEditorResources());
            }
    ...
    private OnItemDeleteListener mItemOnDeleteListener;

    public void setItemOnDeleteListener(OnItemDeleteListener mItemOnDeleteListener) {
        this.mItemOnDeleteListener = mItemOnDeleteListener;
    }
    ...
    public interface OnItemDeleteListener {
        void onItemDelete(LocalMedia localMedia, int pos, View view);
    }
}
