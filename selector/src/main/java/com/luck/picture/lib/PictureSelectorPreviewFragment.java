...
public class PictureSelectorPreviewFragment extends PictureCommonFragment {
    ...
    protected void initPreviewSelectGallery() {
        ...
        bottomNarBar.setData(getActivity(), mData, true);
        mGalleryAdapter = bottomNarBar.mGalleryAdapter;
        mGalleryRecycle = bottomNarBar.rvPreviewList;
    ...
    private void deletePreview() {
        if (selectorConfig.onExternalPreviewEventListener != null) {
            ...
            mGalleryAdapter.notifyItemRemoved(currentItem);
        }
    }
